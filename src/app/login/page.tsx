            ...
            <Section spacing="md">
                <div className="w-full flex flex-col items-center">
                    ...
                    <div className="mb-10 flex flex-col items-center text-center">
                        <div className="relative w-40 h-40 md:w-48 md:h-48 mb-6 drop-shadow-2xl animate-float-gentle">
                            <Image 
                                src="/mascot.png" 
                    ...
                    {/* Login Form */}
                    <div className="w-full glass-card-premium p-8 md:p-10 rounded-[2.5rem] border border-white/50 shadow-premium">
                        <form onSubmit={handleSubmit} className="space-y-6">
                            <div className="space-y-3">
                                <Input
                                    ...
                                    type="email"
                                    placeholder="Email"
                                    className="h-14 rounded-2xl bg-white/50 border-slate-100 focus:ring-primary/20 transition-all px-6 text-base font-bold shadow-sm"
                                    value={email}
                            ...
                            <Button 
                                type="button" 
                                variant="outline" 
                                className="w-full h-14 rounded-2xl border-slate-100 bg-white/50 font-bold flex items-center justify-center gap-3 hover:bg-white hover:border-primary/20 transition-all text-slate-600 shadow-sm active-bounce"
