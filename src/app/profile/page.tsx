  ...
  return (
    <AppShell showNav={true} maxWidth="md">
        <Section spacing="sm">
            <VisualPageHeader
               title="Dein Profil"
               subtitle="Manage your Mastery Account"
        ...
        <Section spacing="md">
            <form onSubmit={handleSubmit} className="space-y-8">
               {/* Profile Card */}
               <div className="glass-card-premium p-8 md:p-10 rounded-[2.5rem] space-y-8 border border-white/50 shadow-premium">
                  ...
                  <Button type="submit" className="w-full h-12 rounded-2xl text-sm font-black btn-orange shadow-premium" disabled={saving}>
               ...
               <div className="space-y-4">
                  <div className="flex items-center justify-between p-6 glass-card-premium rounded-[2rem] border border-white/50 shadow-premium">
