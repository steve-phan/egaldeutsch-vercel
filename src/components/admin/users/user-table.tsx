        ...
        >
          <div className="flex items-center gap-6 flex-1 w-full">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 mb-1">
                 <h3 className="text-lg font-black text-slate-800 tracking-tight italic">{user.name}</h3>
              </div>
          ...
          <div className="flex items-center gap-3 shrink-0 self-end md:self-center">
             <button 
               ...
               className={`h-10 w-10 rounded-xl flex items-center justify-center shadow-sm transition-all
                  ${user.role === 'admin' 
