...
export function SignupClientView() {
    const {
        name,
        email,
        password,
        ...
        <AppShell >
            ...
            <Section spacing="md">
                <div className="w-full flex flex-col items-center">
                    ...
                    {/* Signup Card */}
                    <div className="w-full max-w-md glass-card-premium p-4 md:p-8 rounded-[1.5rem] md:rounded-[2.5rem] border border-white/50 shadow-premium">
