---
title: "Plusquamperfekt: The Past Before the Past in German"
description: "Master the Plusquamperfekt (Past Perfect) to tell stories and sequence events accurately in German. Learn the rules of 'nachdem' and 'bevor'."
level: "B1-B2"
category: "Tenses"
tags: ["grammar", "tenses", "past tense", "plusquamperfekt", "verbs", "storytelling"]
date: "2026-05-29"
---
...
**The Formula:**
Subject + **hatte / war** + [Middle of sentence] + **Partizip II**
...
* *Perfekt:* Ich habe die Hausaufgaben gemacht. (I did the homework.)
* *Plusquamperfekt:* Ich **hatte** die Hausaufgaben **gemacht**. (I **had** done the homework.)

* *Perfekt:* Wir haben einen Kaffee getrunken. (We drank a coffee.)
* *Plusquamperfekt:* Wir **hatten** einen Kaffee **getrunken**. (We **had** drunk a coffee.)
...
* *Perfekt:* Er ist nach Hause gegangen. (He went home.)
* *Plusquamperfekt:* Er **war** nach Hause **gegangen**. (He **had** gone home.)

* *Perfekt:* Der Zug ist abgefahren. (The train departed.)
* *Plusquamperfekt:* Der Zug **war** schon **abgefahren**. (The train **had** already departed.)
...
1. First: I ate dinner. (7:00 PM)
2. Second: I watched a movie. (8:00 PM)
...
*(After I had eaten dinner, I watched a movie.)*

**Notice the sentence structure!** 
*Nachdem* is a subordinating conjunction (a "verb-kicker"). It kicks the helping verb (*hatte*) to the very end of its clause. Then we have a comma. Because the *nachdem*-clause occupies Position 1 of the whole sentence, the main clause MUST start with its conjugated verb (*habe*). This gives us the famous **Verb, Verb** structure!

### More "Nachdem" Examples:
* *Nachdem er die Prüfung bestanden **hatte**, **machte** er eine große Party.*
*(After he had passed the exam, he threw a big party.)*

* *Nachdem wir in Rom angekommen **waren**, **sind** wir sofort ins Hotel **gegangen**.*
*(After we had arrived in Rome, we went immediately to the hotel.)*
...
* *Bevor ich einen Film **sah** (Präteritum), **hatte** ich zu Abend **gegessen** (Plusquamperfekt).*
*(Before I watched a movie, I had eaten dinner.)*

* *Bevor wir ins Hotel **gingen**, **waren** wir in Rom **angekommen**.*
*(Before we went to the hotel, we had arrived in Rome.)*
...
* *Er war sehr müde, weil er den ganzen Tag **hatte** arbeiten **müssen**.*
*(He was very tired because he had had to work all day.)*
...
1. **Identify the Timeline:** Did Action A happen before Action B?
2. **Assign Tenses:** 
   * Action A (the older event) gets the **Plusquamperfekt**.
   * Action B (the newer event) gets the **Perfekt** or **Präteritum**.
3. **Choose the Helping Verb:** For the Plusquamperfekt, does the verb require *sein* (motion/change of state)? Use **war**. Otherwise, use **hatte**.
4. **Apply Conjunction Rules:** 
...
1. After I had woken up, I drank a coffee. (aufwachen - takes sein!)
2. Before he bought the car, he had saved a lot of money. (sparen - takes haben)
3. I could not buy the bread because I had forgotten my money. (vergessen - takes haben)

**Answers:**
1. *Nachdem ich aufgewacht **war**, **habe** ich einen Kaffee **getrunken**.*
2. *Bevor er das Auto **kaufte**, **hatte** er viel Geld **gespart**.*
3. *Ich konnte das Brot nicht kaufen, weil ich mein Geld vergessen **hatte**.*
